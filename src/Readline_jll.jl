...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Readline_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("05236dd9-4125-5232-aa7c-9ec0c9b2c25a"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Readline", artifacts_toml) for e in artifacts["Readline"]]
...
if best_platform === nothing
    @debug("Unable to load Readline; unsupported platform $(triplet(platform_key_abi()))")
else
