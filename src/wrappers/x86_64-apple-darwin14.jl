# Autogenerated wrapper script for Readline_jll for x86_64-apple-darwin14
...
const libreadline_splitpath = ["lib", "libreadline.8.0.dylib"]
...
const libreadline = "@rpath/libreadline.8.dylib"


# Relative path to `libhistory`
const libhistory_splitpath = ["lib", "libhistory.8.0.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libhistory = "@rpath/libhistory.8.dylib"
